/* tutorial.js — numbered callout circles for the *_tutorial study conditions
   ...
   grid or flex item of it and never moves the layout it annotates. */
    ...
    const TUTORIAL_SINGLE_BADGES = [
      { n: 1, selector: ".single-panel-heading", index: 0, title: "The case being decided" },
      ...
      { n: 4, selector: ".single-panel-heading", index: 1, title: "What the AI system decided" },
      { n: 5, selector: ".single-prediction-result", place: "left", title: "The predicted class" },
      { n: 6, selector: ".single-explanation-link", place: "below", title: "Opens which attributes pushed the prediction" },
      { n: 7, selector: ".single-panel-heading", index: 2, title: "How good that AI is, for people like this case" },
